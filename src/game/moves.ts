...
// follows single-card rules; longer chains can target any empty category slot,
// any locked category slot whose category matches the chain, or a board slot
// whose top accepts the chain bottom.
